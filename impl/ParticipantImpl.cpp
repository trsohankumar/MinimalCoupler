...
namespace MinimalCoupler
{
    ...
    void ParticipantImplementation::initialize()
    {
        ...
        _couplingScheme.initialize(
            _participantName,
            _meshes.at(
                (_participantName == "Solid") ?
                    _participantMeshName: _remoteParticipantMeshName).get(),
            _remoteSocket);
    ...
    void ParticipantImplementation::mapWriteData()
    {
        ...
        NearestNeighbor::mapConservative(
            _meshes.at(_participantMeshName)->getWriteMapping(), fluidForceData,
            solidForceData,
    ...
    void ParticipantImplementation::mapReadData()
    {
        ...
        const auto &solidDispData = _meshes.at(_remoteParticipantMeshName)->getDataField(_remoteParticipantDataName, currentTime);

        NearestNeighbor::mapConsistent(
            _meshes.at(_participantMeshName)->getReadMapping(), solidDispData,
            fluidDispData,
            _meshes.at(_participantMeshName)->getMeshDimensions());
    ...
    void ParticipantImplementation::advance(
    ...
    void ParticipantImplementation::startProfilingSection(
